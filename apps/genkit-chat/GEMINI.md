...
## Using @genkit-ai/vibe Components

This demo uses the shared `@genkit-ai/vibe` library:

```typescript
import { ChatBoxComponent } from '@genkit-ai/vibe/chat';
...
See the library README at `../vibe/README.md` for full documentation.
